...
groth16_near_bindings!(cli, TransferPub<PoolBN256<IN, OUT, H>>, CTransferPub, TransferSec<PoolBN256<IN, OUT, H>>, CTransferSec, POOL_PARAMS, c_transfer, gen_test_data);
